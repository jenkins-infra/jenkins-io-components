...
@halkeye/jenkins-io-components is distributed on npm, so you can install it locally or use it via npm CDNs like unpkg.com.
...
<script data="jio" src="https://unpkg.com/@halkeye/jenkins-io-components?module" type="module"></script>
<script data="jio" nomodule="" src="https://unpkg.com/@halkeye/jenkins-io-components"></script>
````
